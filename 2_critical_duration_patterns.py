...
from ARR2019_config import storms, durations, quantities, proc_directory, locations, blockage
...
for storm in storms:
    for quantity in quantities:        
        ...
        points_dict = post_process(durations=durations, locations=locations, storm=storm, quantity=quantity, proc_directory=proc_directory, blockage=blockage)
